...
- Виправлено проблему з попередньо визначеними об'єктами XML `r'&|>|<|_|"|\.\.+|\s\s+'` (для Konspekt.exe для української мови до версії від 03-11-2018).
- Виправлені проблеми з кодиваннями utf-8/windows-1251.

### 👍 Покращення

- Додана функція динамічного визначення часу на тривалість роботи Konspekt.exe для української мови до версії від 03-11-2018:
```python
